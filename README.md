...
> **출처·권리 관계.** **Bad Kids NFT 컬렉션은 본 프로젝트의 발행자(1XP Inc.)가 보유한 자산이 아니다.** Stargaze 생태계에서 외부 주체에 의해 발행된 9,999개 컬렉션이며, 저작권·상표·발행 권리는 컬렉션의 원 발행 주체와 보유자에게 있다. BadChain은 PoBK 합의에서 이 컬렉션을 *검증인(Balidator) 정체성 단위*로 **활용**할 뿐이며, 통합·브릿지는 컬렉션 권리자와의 별도 협의 및 합의를 전제로 한다. 이 백서는 BadChain의 기술 설계를 다루며, Bad Kids 컬렉션 자체에 대한 어떠한 권리 주장도 하지 않는다.
